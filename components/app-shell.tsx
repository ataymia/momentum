...
const primaryNav:NavItem[]=[
  ...
  {key:"inventory",label:"Supply & inventory",icon:Boxes},{key:"marketing",label:"Marketing",icon:Megaphone},
  {key:"people",label:"People & HR",icon:UsersRound},{key:"payroll",label:"Payroll",icon:BadgeDollarSign},
  {key:"finance",label:"Finance & expenses",icon:CircleDollarSign},
];
