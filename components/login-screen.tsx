...
const tourCopy: Record<(typeof tourIds)[number], string> = {
  "usr-flo": "Full company oversight",
  "usr-mia": "Cross-functional operations",
  "usr-avery": "Team workflow & approvals",
  "usr-jordan": "Field sales & own records",
  "usr-customer": "Business ordering & account view",
};
