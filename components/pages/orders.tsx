...
export function OrdersPage() {
  ...
  const sourcePlacement = sourcePlacementId ? scope.placements.find((placement)=>placement.id===sourcePlacementId&&placement.accountId===form.accountId) : undefined;
