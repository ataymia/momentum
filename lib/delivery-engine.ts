...
export type DeliveryEventType = "Accepted" | "Assigned" | "Loaded" | "Departed" | "Delivered" | "Cancelled" | "Note";
...
const eventTypes = new Set<DeliveryEventType>(["Accepted", "Assigned", "Loaded", "Departed", "Delivered", "Cancelled", "Note"]);
