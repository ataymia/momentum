...
/**
 * Permanently deletes an employee's Firebase identity and every Firestore record that grants them access.
 *
 * This is what frees the work e-mail: until the identity is gone, provisioning the same address again
